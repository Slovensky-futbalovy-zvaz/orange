...
const EMPTY_PAIR: PairForm = { personName: "", department: "", profileType: "P", monthlyServiceLimit: "20" };
...
export default function ReportPage({ params }: { params: { month: string } }) {
  ...
  function openPair(inv: Invoice, e: React.MouseEvent) {
    ...
    setPairForm({ personName: inv.personName || "", department: inv.department || "", profileType: inv.profileType || "P", monthlyServiceLimit: String(inv.monthlyServiceLimit ?? 20) });
  }
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 p-6">
            ...
            <div className="space-y-3">
              ...
              <PairField label="Stredisko" value={pairForm.department} onChange={(v) => setPairForm({ ...pairForm, department: v })} />
              <PairField label="Typ profilu" value={pairForm.profileType} onChange={(v) => setPairForm({ ...pairForm, profileType: v })} />
