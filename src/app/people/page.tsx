...
export default function OsobyPage() {
  ...
  const { values: departments } = useCodebook("department");
        ...
        <div className="mb-4 p-5 bg-white rounded-xl border border-orange-200 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <CodebookSelect
              ...
              onChange={(v) => setForm({ ...form, profileType: v })}
...
function CodebookSelect({ label, value, onChange, options, placeholder }: {
  label: string; value: string; onChange: (v: string) => void;
  options: string[]; placeholder?: string;
}) {
  // Ak existujúca hodnota nie je v číselníku, pridaj ju ako extra option
